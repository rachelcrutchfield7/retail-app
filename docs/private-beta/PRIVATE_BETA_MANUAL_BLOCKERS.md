...
| Android build status | Manual verification required | Codex/Rachel | Corrected EAS Android preview APK build `1bacbcf6-bfb9-4a36-9e69-39e3b7e7b59b` finished successfully from commit `99998e9d8b3e55c289ad96894d0ed7f00335fb74`. Rachel must install and open it on device before outside testers are invited. |
