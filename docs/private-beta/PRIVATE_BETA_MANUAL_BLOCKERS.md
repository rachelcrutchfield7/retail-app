...
| Android build status | Blocked | Codex/Rachel | First EAS Android preview APK build `a6fcb7b1-3b57-432a-b348-64e5541923dc` installed successfully, then failed initial startup with the global error boundary. Second build `7a9364af-eadb-4580-ba66-2df791e3ce92` installed and opened successfully, but startup was blocked because compiled Supabase public configuration was missing. A third corrected APK is required. |
